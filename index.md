...
よく使うアプリを大きなボタンで表示できるAndroidホームアプリです。
...
4. 配置したいスロットをタップし、「未配置ショートカット」の中から追加したショートカットを選んで配置します
...
<img src="images/カレンダー.png" alt="内蔵カレンダー" width="300">
...
### スロットの色変更　(プレミアム機能)
各ショートカットの背景色と文字色を個別に変更できます。重要なショートカットを目立たせたり、カテゴリごとに色分けするなど、自分好みの見た目にカスタマイズできます。
